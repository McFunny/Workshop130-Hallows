...
public class StructureManager : MonoBehaviour
{
    ...
    public GameObject weedTile, farmTree, farmTile, crowPod, crowWithNut, boulder, buriedItem, barricade, trough, wBearTrap, bearTrap, critterHive, buriedKukri, fence, cocoons;
...
#region TileCommands
    ...
    IEnumerator SpawnStartingStructures()
    {
        ...
        StartCoroutine(PopulateStructure(3, 8, cocoons, true, barnTileMap));
