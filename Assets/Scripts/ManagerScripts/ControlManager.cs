...
public class ControlManager : MonoBehaviour
{
    ...
    select, split, waterGunCharge, dropItem, holdInteraction, minigamePress, minigameExit, hotbarSwitch, codexOpen, deleteQuest, codexSelect, waterJet, secondaryCharge;
