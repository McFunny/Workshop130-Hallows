...
public class UIMenuButton : MonoBehaviour
{
    ...
    public Color c_deselected = new Color(0.8509804f, 0.7490196f, 0.2078431f, 1.0f);
    public Color c_selected = new Color(1f, 0.8870801f, 0.2877358f, 1.0f);
    public Color c_disabled = new Color(0.5660378f, 0.5029674f, 0.1682093f, 1.0f);
    public Color c_interactable = new Color(1f, 1f, 1f, 1);
